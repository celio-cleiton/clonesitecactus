import { ChakraProvider, Box, Heading, Text, Flex, Image, SimpleGrid, Link, Button } from '@chakra-ui/react';
    ...
    <ChakraProvider>
      <Box bg="gray.100" minH="100vh">
        <Box bg="teal.500" color="white" py="20" textAlign="center">
          ...
          <Text fontSize="xl">Confira alguns dos projetos incríveis que entregamos com sucesso.</Text>
        </Box>
